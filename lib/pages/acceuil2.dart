    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                      'assets/ami41.jpeg'), // Assurez-vous que votre image est dans le dossier assets
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Text(
            'Build the future by completing task, you unlock your  potential and achieve sucess',
            style: TextStyle(
              color: Colors.white,
              fontSize: 18,
            ),
